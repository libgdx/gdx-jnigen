...
*/
    ...
    */
    ...
    static {
        ...
        ffiIdMap.put(11, CHandler.constructStackElementCTypeFromNativeType(getNativeType(11)));
        ffiIdMap.put(12, CHandler.constructStackElementCTypeFromNativeType(getNativeType(12)));
